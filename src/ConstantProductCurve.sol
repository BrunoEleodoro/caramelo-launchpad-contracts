...
contract ConstantProductCurve is ICurve {
     ...
     */
    function checkCompatability(uint256 yMin, uint256 yMax, uint256 xMax, uint256 xTotal) public pure returns (bool) {
     ...
     */
    function fPrimeX(uint256 x, uint256 yMin, uint256 yMax, uint256 xMax, uint256 xTotal) public pure returns (uint256) {
        if (!checkCompatability(yMin, yMax, xMax, xTotal)) revert ICurve__InvalidInput();
        uint256 k = getK(xTotal, xMax, yMax);
        uint256 q = getQ(yMin, yMax);
        return Math.mulDiv(k, 1e18, (((q * xTotal) / Q_DENOM - x) ** 2), Math.Rounding.Floor);
    }
     ...
     */
    function fX(uint256 x, uint256 yMin, uint256 yMax, uint256 xMax, uint256 xTotal) public pure returns (uint256) {
        if (!checkCompatability(yMin, yMax, xMax, xTotal)) revert ICurve__InvalidInput();
        uint256 k = getK(xTotal, xMax, yMax);
        uint256 q = getQ(yMin, yMax);
     ...
     */
    function fY(uint256 y, uint256 yMin, uint256 yMax, uint256 xMax, uint256 xTotal) public pure returns (uint256) {
        if (!checkCompatability(yMin, yMax, xMax, xTotal)) revert ICurve__InvalidInput();
        if (y == 0) return 0;
        uint256 k = getK(xTotal, xMax, yMax);
        uint256 q = getQ(yMin, yMax);
        return Math.mulDiv(((q * xTotal) / Q_DENOM) ** 2, y, (q * xTotal * y) / Q_DENOM + k);
    }
    ...
    function evaluateDx(uint256 x1, uint256 x2, uint256 yMin, uint256 yMax, uint256 xMax, uint256 xTotal) external pure returns (uint256) {
        ...
        return fX(x2, yMin, yMax, xMax, xTotal) - fX(x1, yMin, yMax, xMax, xTotal);
    }
    ...
    function evaluateDy(uint256 y1, uint256 y2, uint256 yMin, uint256 yMax, uint256 xMax, uint256 xTotal) external pure returns (uint256) {
        ...
        return fY(y2, yMin, yMax, xMax, xTotal) - fY(y1, yMin, yMax, xMax, xTotal);
    }
     ...
     */
    function getK(uint256 xTotal, uint256 xMax, uint256 yMax) public pure returns (uint256) {
